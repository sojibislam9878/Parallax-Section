		...
		${sectionSl} {
			...
			@media  (min-width:641px) and (max-width: 1024px){
      		...
      		margin: ${layout?.t5LayoutSetting?.card?.colGap} 0;
				...
				${t6ModalSl} .btn{
				${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getColorsCSS)(styles?.t5Styles?.modal?.btn?.colors)}
				}
				${t6ModalSl} .btn:hover{
				${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getColorsCSS)(styles?.t5Styles?.modal?.btn?.hovColors)}
...
/***/ "./src/Components/Common/Themes/BlurEffectParallax.js":
/*!************************************************************!*\
  !*** ./src/Components/Common/Themes/BlurEffectParallax.js ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const BlurEffectParallax = ({
  ...
  const parallaxBgRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  const heroContentRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  const heroSectionRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (BlurEffectParallax);
...
const ParticleParallax = ({
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    function createParticles() {
      ...
      for (let i = 0; i < count; i++) {
        ...
        const color = `rgba(${particles.color.r}, ${particles.color.g}, ${particles.color.b}, ${Math.random() * 0.5})`;
        particlesArray.push({
          x,
          y,
          size,
      ...
      for (let i = 0; i < particlesArray.length; i++) {
        for (let j = i + 1; j < particlesArray.length; j++) {
          ...
          if (distance < 100) {
            ...
            ctx.strokeStyle = `rgba(${particles.color.r}, ${particles.color.g}, ${particles.color.b},${0.3 * (1 - distance / 100)})`;
            ctx.lineWidth = 1;
            ctx.stroke();
          }
        }
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    id: "parallax-text"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h1", null, isBackend ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
    tagName: "span",
  ...
  }, btn1.text)), btn2.status && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    target: options.isNewTab ? "_blank" : "_self",
    rel: "noreferrer",
    href: btn2.link
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
...
const parallaxInit = (el, parentEl, scrollTop = false) => {
...
const themeChanger = (theme = "theme1", attributes) => (0,immer__WEBPACK_IMPORTED_MODULE_0__.produce)(attributes, draft => {
  ...
  switch (theme) {
    ...
    case "theme1":
      ...
      draft["styles"]["background"]["type"] = "image", draft["contents"]["title"]["color"] = "#2d2d2d", draft["contents"]["description"]["color"] = "white", draft["styles"]["textAlign"] = "left";
    ...
    case "theme2":
      ...
      draft["styles"]["background"]["type"] = "image", draft["contents"]["title"]["color"] = "#fff", draft["contents"]["description"]["color"] = "white", draft["styles"]["textAlign"] = "center";
      draft["contents"]["btns"]["btn1"]["colors"]["color"] = "white";
      draft["contents"]["btns"]["btn1"]["colors"]["bg"] = "#ff4757";
      draft["contents"]["btns"]["btn1"]["hoverColors"]["color"] = "white";
      draft["contents"]["btns"]["btn1"]["hoverColors"]["bg"] = "#ff6b81";
    ...
    case "theme3":
      // draft["styles"]["background"]["image"]["url"] = "https://templates.bplugins.com/wp-content/uploads/2025/05/Screenshot-2025-05-17-105053.png",
      draft["styles"]["background"]["type"] = "gradient", draft["contents"]["title"]["color"] = "linear-gradient(to right, #38bdf8, #34d399)", draft["contents"]["subTitle"]["color"] = "white";
      draft["contents"]["description"]["color"] = "white";
      draft["contents"]["btns"]["btn1"]["colors"]["color"] = "white";
      draft["contents"]["btns"]["btn1"]["colors"]["bg"] = "linear-gradient(to right, #38bdf8, #34d399)";
      draft["contents"]["btns"]["btn1"]["hoverColors"]["color"] = "white";
      draft["contents"]["btns"]["btn1"]["hoverColors"]["bg"] = "linear-gradient(to right, #0ea5e9, #10b981)";
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  parallaxEls.forEach(parallaxEl => {
    ...
    if (selectedTheme === "default") {
      ...
      (0,react_dom_client__WEBPACK_IMPORTED_MODULE_1__.createRoot)(styleRoot).render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_Style__WEBPACK_IMPORTED_MODULE_2__["default"], {
        attributes,
        id: parallaxEl.id
      }));
      if (parallaxImgEl) {
      ...
      (0,react_dom_client__WEBPACK_IMPORTED_MODULE_1__.createRoot)(parallaxEl).render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: className,
        id: parallaxEl.id
